#pragma once
#include "Manager.h"
#include "PrivateTrainer.h"
class ClubA :public Manager
{
	friend class Administrator;
public:

	vector<PrivateTrainer> trainers;

	int m_traNum;

	bool m_traFileIsEmpty;

	void init_Tra();

	ClubA(int type,int id,string name, int rank,string m_managerAccount,string m_managerPassword);
	...
	void createCustomTrainingPlan(int index);

	void displayTrainingPlan(int index);
